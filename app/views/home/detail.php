    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse g-5 py-5">
            <div class="col-10 col-sm-8 col-lg-6 img-detail">
                <img src="<?= BASEURL ?>/img/<?= $data['blog']['gambar'] ?>" class="d-block mx-lg-auto img-fluid" alt="<?= $data['blog']['judul'] ?>" width="700"
            ...
            <div class="col-lg-6">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <button type="button" class="btn btn-primary btn-lg px-4 me-md-2"
                        fdprocessedid="47xge1">Primary</button>
                    <button type="button" class="btn btn-outline-secondary btn-lg px-4"
                        fdprocessedid="wu87v5">Default</button>
                </div>
            </div>
        </div>
    </div>
